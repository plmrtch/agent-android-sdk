package com.palamartech.agent_sdk;
 ...
 * Use the {@link ChatWindow#newInstance} factory method to
...
public class ChatWindow extends Fragment {
    ...
    public static ChatWindow newInstance(String param1, String param2) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                txtGreeting.setText(edtMessageBox.getText());
